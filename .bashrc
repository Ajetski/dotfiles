...
if [ "$color_prompt" = yes ]; then
	PS1="${debian_chroot:+($debian_chroot)}\[\033[01;34m\]\u\[\033[01;37m\]@\[\033[01;033m\]\h\[\033[00m\]:\[\033[01;36m\]\w \[\033[01;32m\]\$(git symbolic-ref --short HEAD 2>/dev/null | sed -r \"s/^(.+)$/(\1) /\")\[\033[00m\]\$ "
else

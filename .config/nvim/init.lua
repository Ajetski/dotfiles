        ...
        defaults = {
          mappings = {
            i = {
              ...
              ['<c-j>'] = {
                function(buf)
                  require('telescope.actions').move_selection_next(buf)
                end,
                type = 'action',
              ...
              ['<c-k>'] = {
                function(buf)
                  require('telescope.actions').move_selection_previous(buf)
                end,
                type = 'action',
                opts = { nowait = true, silent = true },
              },
...
-- compile fennel plugins
require('aniseed.env').init()
-- load fennel config
local status, main = pcall(require, 'main')
...
vim.keymap.set('n', '<leader>fr', "<cmd>lua require'telescope.builtin'.buffers({ show_all_buffers = true })<cr>", default_opts)
